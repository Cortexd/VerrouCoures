        ...
        s.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    Toast.makeText(getApplicationContext(), "Utilisation du wifi maison " + conf.getUrlWebServiceWifi(),
                            Toast.LENGTH_SHORT).show();
                } else {

                    ApplicationConfig conf = ApplicationConfig.getConfig();
                    conf.setUrlWebService(conf.getUrlWebServiceInternet());
                    Toast.makeText(getApplicationContext(), "Utilisation cnx internet " + conf.getUrlWebServiceInternet(),
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
